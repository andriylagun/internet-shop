...
<div class="container" align="center">
    ...
    <form method="post" action="/register">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="login" name="login" type="text" style="text-align: center; width: 500px">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="passwordEdit">Password:</label>
                        <input class="form-control" id="passwordEdit" name="psw" type="password" style="text-align: center; width: 500px">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="passwordRepeat">Please repeat your password:</label>
                        <input class="form-control" id="passwordRepeat" name="pswRepeat" type="password" style="text-align: center; width: 500px">
                    </div>
